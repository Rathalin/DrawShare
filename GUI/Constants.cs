...
namespace GUI
{
    public static class Constants
    {
        ...
        public static string _regexIP = "(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])";
        ...
        public static string DNS_GetIP_URI { get; private set; } = "http://checkip.dyndns.org";
    }
}
